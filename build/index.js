...
const liveSearch = new (_modules_Search__WEBPACK_IMPORTED_MODULE_3___default())();
const amazingSearch = new (_modules_Search__WEBPACK_IMPORTED_MODULE_3___default())();
...
(function () {
  ...
  const events = {
    keyPressDispatcher(e) {
      if (e.keyCode === 83 && isOverlayOpen === false) events.openOverlay();
      if (e.keyCode === 27 && isOverlayOpen === true) events.closeOverlay();
    },
    openOverlay() {
    ...
    getResults() {
      fetch('http://fictional-university.local/wp-json/wp/v2/posts?search=' + searchField.value).then(res => res.json()).then(posts => {
        resultsDiv.innerHTML = `
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkinternational_dessert_theme"] = self["webpackChunkinternational_dessert_theme"] || [];
